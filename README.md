...
|--|--|--|
| **For** | Voice · UC · Contact Center | AI learners & builders |
...
| **Download** | [Campus zip](https://github.com/cipher0x9/uc-lab-free-university/releases/download/v17.1-mobile/v17-UNIVERSITY.html.zip) | [Campus zip](https://github.com/cipher0x9/ai-lab-free-university/releases/download/v4.1-mobile/v4-PORTFOLIO.html.zip) |
| **Proof** | **LICC** — Leg · ID · Counter · Capture | **RTMA** — Run · Trace · Metric · Artifact |
| **Open** | Chrome · Safari · Edge · Firefox (full browser) | Same |

**Tip:** Desktop is smoothest. Phone works in a **full browser** (not in-app browsers). First open can take a moment.
